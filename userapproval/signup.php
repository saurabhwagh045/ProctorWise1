...
<html lang="en">
  ...
  <body>
          ...
          echo ' <div class="alert alert-warning alert-dismissible fade show" role="alert">
           ...
           <div class="container">
          <h1 class="text-center">signUp to Our ProctorWise as Student</h1>
               <form action="/userapproval/signup.php" method="post" enctype="multipart/form-data">
                              <div class="mb-3">
                                <label for="username" class="form-label">PRN Number</label>
                                <input type="text" class="form-control" id="username" name="username" aria-describedby="emailHelp">
                                <div id="emailHelp" class="form-text">Use Your PRN For Registrations.</div>
                              </div>
                              <div class="mb-3">
                              ...
                              <div class="mb-3">
                                ...
                                <input type="text" pattern="\d{12}" class="form-control" id="adhar" name="adhar" aria-describedby="emailHelp" required>
                              </div>
                              <div class="mb-3">
